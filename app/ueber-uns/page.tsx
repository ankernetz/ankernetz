...
const TRANS = {
  ...
  en: {
    ...
    zeitleiste: [
      ...
      { jahr: "2022", ereignis: "Anchor Clothing",          detail: "Launch of the specialised clothing service by clinical profile." },
    ...
    angebote: [
      ...
      { titel: "Anchor Clothing",             sub: "Clothing by clinical profile",        href: "/ankerkleidung" },
