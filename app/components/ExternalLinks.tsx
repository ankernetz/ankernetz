...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Schulpsychologischer Dienst Berlin", detail: "berlin.de/sen/bildung", desc: "Psychologische Beratung für Schüler und Eltern.", url: "https://www.berlin.de/sen/bildung/unterstuetzung/schulpsychologie/" },
  ...
  },
  {
    ...
    items: [
      { name: "Jugendamt Mitte", detail: "berlin.de/ba-mitte/jugend", desc: "Jugendhilfe im Bezirk Mitte.", url: "https://www.berlin.de/ba-mitte/politik-und-verwaltung/aemter/jugendamt/" },
  ...
  },
  {
    ...
    items: [
      { name: "Charité — Kinder- und Jugendpsychiatrie", detail: "charite.de/kjp", desc: "Universitätsklinik KJP, Campus Virchow und Mitte.", url: "https://psychiatrie.charite.de/kinder_und_jugendpsychiatrie/" },
      { name: "Vivantes — Kinder- und Jugendpsychiatrie", detail: "vivantes.de", desc: "KJP Neukölln und Reinickendorf.", url: "https://www.vivantes.de/kinder-jugendpsychiatrie" },
      { name: "DRK Kliniken Berlin — KJP", detail: "drk-kliniken-berlin.de", desc: "Kinder- und Jugendpsychiatrie Westend.", url: "https://www.drk-kliniken-berlin.de" },
      { name: "Evangelisches Krankenhaus Königin Elisabeth", detail: "ekh-berlin.de", desc: "KJP im Nordosten Berlins.", url: "https://www.ekh-berlin.de" },
      { name: "KJPD Berlin", detail: "Kinder- und Jugendpsychiatrischer Dienst", desc: "Ambulante KJ-psychiatrische Versorgung aller Bezirke.", url: "https://www.berlin.de/sen/jugend/gesundheit-und-psychiatrie/kinder-und-jugendpsychiatrische-dienste/" },
    ],
  },
  {
    ...
    items: [
      ...
      { name: "Landesjugendamt Brandenburg", detail: "kvjs.de", desc: "Überregionale Jugendamtsaufgaben im Land Brandenburg.", url: "https://www.landesjugendamt.de" },
      ...
      { name: "Caritas Brandenburg", detail: "caritas-bb.de", desc: "Caritasverband für das Bistum Berlin in Brandenburg.", url: "https://www.caritas-berlin.de" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Deutsche Kinderhilfe", detail: "kinderhilfe.de", desc: "Anwaltschaft und Lobby für Kinderrechte.", url: "https://www.kinderhilfe.de" },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Europäische Kommission — Jugend", detail: "ec.europa.eu/youth", desc: "EU-Jugendpolitik, Förderungen, Europäisches Solidaritätskorps.", url: "https://commission.europa.eu/education/education-and-training-policies/youth_de" },
