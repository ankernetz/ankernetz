...
const TRANS = {
  de: {
    ...
    ctaBody: "Unser Krisentelefon ist rund um die Uhr besetzt - auch nachts, an Wochenenden und Feiertagen. Kein Wartezimmer, keine Bürokratie, keine Warteliste.",
    ctaBtn2: "Krisenintervention",
    ctaBtn3: "Platzanfrage stellen",
    offersEyebrow: "Alle Angebote von Ankernetz",
    offers: [
  ...
  en: {
    ...
    ctaBody: "Our crisis line is staffed around the clock - nights, weekends and public holidays included. No waiting room, no bureaucracy, no waiting list.",
    ctaBtn2: "Crisis Intervention",
    ctaBtn3: "Request a place",
    offersEyebrow: "All services from Ankernetz",
    offers: [
      { href: "/krisenintervention",   label: "Crisis Intervention 24/7",       desc: "Immediate protection in emergencies" },
      { href: "/psychotherapie",        label: "Psychotherapy",                  desc: "Insured therapy for children & young people" },
      { href: "/fruehe-hilfen",         label: "Early Help",                    desc: "Support from birth" },
      { href: "/therapie-wohnen",       label: "Therapeutic Housing",           desc: "Inpatient care & stabilisation" },
    ...
    faq: [
      ...
      },
      {
        ...
        a: "Place requests can be submitted via our online form, by e-mail, or by phone. For crisis interventions our on-call service is available around the clock. For inpatient placements the request is usually made through the responsible youth welfare office.",
      },
      {
...
function renderSection(section: ArticleSection, index: number) {
  switch (section.type) {
    case "h2":
      return (
        <h2 key={index} style={{ fontSize: "clamp(1.375rem, 2.5vw, 1.75rem)", fontWeight: 700, color: "#1A1614", letterSpacing: "-0.02em", lineHeight: 1.25, marginTop: "3rem", marginBottom: "1rem" }}>
          {section.content as string}
        </h2>
      );
    case "h3":
      return (
        <h3 key={index} style={{ fontSize: "1.125rem", fontWeight: 700, color: "#1A1614", letterSpacing: "-0.015em", lineHeight: 1.35, marginTop: "2rem", marginBottom: "0.75rem" }}>
          {section.content as string}
        </h3>
      );
    case "p":
      return (
        <p key={index} style={{ fontSize: "1.0625rem", color: "#3A3230", lineHeight: 1.85, marginBottom: "1.25rem" }}>
          {section.content as string}
        </p>
      );
    case "ul":
      return (
        <ul key={index} style={{ margin: "1rem 0 1.5rem", paddingLeft: "0", listStyle: "none", display: "flex", flexDirection: "column", gap: "0.625rem" }}>
          {(section.content as string[]).map((item, i) => (
            <li key={i} style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem", fontSize: "1rem", color: "#3A3230", lineHeight: 1.75 }}>
              <span style={{ width: "6px", height: "6px", borderRadius: "50%", background: "#8B3A22", flexShrink: 0, marginTop: "0.625rem" }} />
              {item}
            </li>
          ))}
        </ul>
    ...
    case "highlight":
      return (
        <div key={index} style={{ background: "rgba(139,58,34,0.07)", borderLeft: "3px solid #8B3A22", borderRadius: "0 12px 12px 0", padding: "1.25rem 1.5rem", margin: "1.75rem 0" }}>
          <p style={{ fontSize: "1.0625rem", color: "#3A2018", lineHeight: 1.8, fontStyle: "italic", margin: 0 }}>
            {section.content as string}
          </p>
        </div>
      );
  ...
  return (
    <main style={{ background: "#FAF6F1", minHeight: "100vh", paddingTop: "5rem" }}>
      ...
      <header style={{ padding: "4rem 1.5rem 0" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <nav style={{ marginBottom: "2rem", display: "flex", alignItems: "center", gap: "0.5rem" }}>
            <Link href="/aktuelles" style={{ fontSize: "0.875rem", color: "#8B3A22", textDecoration: "none" }}>
              {t.breadcrumbParent}
            </Link>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", marginBottom: "1.5rem" }}>
            <time style={{ fontSize: "0.8125rem", color: "#8B3A22", fontWeight: 600, letterSpacing: "0.05em" }}>
      ...
      <section style={{ padding: "0 1.5rem 0" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          <div style={{ background: "linear-gradient(135deg, #1A1614 0%, #2D1810 100%)", borderRadius: "20px", padding: "2.5rem", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div>
              <p style={{ fontSize: "0.625rem", fontWeight: 600, letterSpacing: "0.2em", textTransform: "uppercase", color: "#C4916F", marginBottom: "0.5rem" }}>
                {t.ctaEyebrow}
              </p>
              <h2 style={{ fontSize: "clamp(1.375rem, 3vw, 1.75rem)", fontWeight: 700, color: "#FFFFFF", letterSpacing: "-0.02em", lineHeight: 1.25, marginBottom: "0.75rem", marginTop: 0 }}>
                {t.ctaH2}
              </h2>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "0.875rem" }}>
              <a href="tel:+493022454322" style={{ display: "inline-flex", alignItems: "center", gap: "0.625rem", background: "#8B3A22", color: "#FFFFFF", padding: "0.875rem 1.5rem", borderRadius: "12px", fontSize: "1rem", fontWeight: 700, textDecoration: "none", letterSpacing: "-0.01em" }}>
                <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M3.5 2h3l1.5 4-1.75 1.25c.9 1.8 2.25 3.15 4.05 4.05L11.5 9.5l4 1.5v3c0 .83-.67 1.5-1.5 1.5C6.33 15.5 2.5 11.67 2.5 7A1.5 1.5 0 0 1 3.5 2z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                030 22 45 43 22
              </a>
              <Link href="/krisenintervention" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(255,255,255,0.1)", color: "#FFFFFF", padding: "0.875rem 1.5rem", borderRadius: "12px", fontSize: "0.9375rem", fontWeight: 600, textDecoration: "none", border: "1px solid rgba(255,255,255,0.15)" }}>
                {t.ctaBtn2}
              ...
              <Link href="/platzanfrage" style={{ display: "inline-flex", alignItems: "center", gap: "0.5rem", background: "rgba(255,255,255,0.1)", color: "#FFFFFF", padding: "0.875rem 1.5rem", borderRadius: "12px", fontSize: "0.9375rem", fontWeight: 600, textDecoration: "none", border: "1px solid rgba(255,255,255,0.15)" }}>
                {t.ctaBtn3}
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none"><path d="M3 7h8M7.5 3.5L11 7l-3.5 3.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              </Link>
            </div>
      ...
      <section style={{ padding: "3rem 1.5rem 0" }}>
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(240px, 1fr))", gap: "0.75rem" }}>
            {t.offers.map((item) => (
              <Link key={item.href} href={item.href} style={{ textDecoration: "none" }} className="service-link-card">
                <div style={{ background: "#ffffff", border: "1px solid rgba(0,0,0,0.07)", borderRadius: "12px", padding: "1.25rem", transition: "border-color 0.15s, box-shadow 0.15s" }}>
                  <p style={{ fontSize: "0.9375rem", fontWeight: 600, color: "#1A1614", margin: "0 0 0.25rem" }}>{item.label}</p>
