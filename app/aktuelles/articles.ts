...

  {
    ...
    sections: {
      de: [
        ...
        { type: "ul", content: ["Erstkontakt über das Platzanfrage-Formular, Telefon oder E-Mail, mit Hinweis auf Herkunftsland und anfragende Stelle", "Erstgespräch zur fachlichen Einschätzung: Passt der Bedarf zu unseren Angeboten?", "Klärung der Finanzierung - Selbstzahler oder individuelle Vereinbarung mit der Behörde", "Bei Passung: Aufnahmegespräch und Beginn der Unterbringung in Berlin", "Laufende Abstimmung mit der zuständigen Stelle im Herkunftsland während der gesamten Unterbringung"] },
