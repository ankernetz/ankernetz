...
export const metadata: Metadata = {
  title: "Platzanfrage Berlin | Jugendamt & Fachkräfte – Ankernetz",
  description:
  ...
  keywords: ["Platzanfrage Jugendhilfe Berlin", "Platz Jugendliche Berlin", "Anfrage Wohngruppe Berlin", "Krisenaufnahme anfragen Berlin", "Jugendamt Anfrage Berlin"],
